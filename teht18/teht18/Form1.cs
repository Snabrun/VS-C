...
namespace teht18
{
    public partial class Form1 : Form
    {
        ...
        private void oppilaitosCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            osLB.Text = oppilaitos.Rows[oppilaitosCB.SelectedIndex]["OKatuosoite"].ToString();
            posNLB.Text = oppilaitos.Rows[oppilaitosCB.SelectedIndex]["OPostinumero"].ToString();
            posPLB.Text = oppilaitos.Rows[oppilaitosCB.SelectedIndex]["OPostitoimipaikka"].ToString();
            puhLB.Text = oppilaitos.Rows[oppilaitosCB.SelectedIndex]["OPuhelin"].ToString();
        ...
        {
            titLB.Text = yhteys.Rows[vastuuhloCB.SelectedIndex]["Vtitteli"].ToString();
            osasLB.Text = yhteys.Rows[vastuuhloCB.SelectedIndex]["VOsasto"].ToString();
            sahLB.Text = yhteys.Rows[vastuuhloCB.SelectedIndex]["VSahkoposti"].ToString();
            puh2LB.Text = yhteys.Rows[vastuuhloCB.SelectedIndex]["VPuhelin"].ToString();
